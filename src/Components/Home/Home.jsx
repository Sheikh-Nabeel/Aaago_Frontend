...
import womanCar from "./Images/countless2.jpg";
...
const Home = () => {
    ...
    let groups = [];
    let index = 0;
    let layoutPattern = [3, 2, 3]; // 3-2-3 pattern
    let layoutIndex = 0;
    ...
    return (
        <>
            <div
                className="relative w-[95%] my-7 rounded-3xl mx-auto  h-[120vh] max-lg:h-auto max-lg:py-10 max-lg:px-2 max-lg:gap-10 bg-cover bg-center flex flex-row-reverse max-lg:flex-col-reverse items-center justify-center"
            ...
            >
                ...
                <div className="relative z-10 w-[60%] max-lg:w-[100%] text-white text-center px-4 max-w-4xl">
                    <div className="inline-block bg-white text-black text-md  px-8 py-2 rounded-full mb-4">
                    ...
                    <div className="flex justify-center gap-4">
                        <button className="bg-[#319A64] hover:bg-green-700 text-white px-6 py-3 rounded-lg text-lg font-semibold">
                            Download App
                        </button>
                        <button className="bg-[#319A64] hover:bg-green-800 text-white flex gap-2 items-center px-6 py-3 rounded-lg text-lg font-semibold">
                            <RiFileDownloadFill /> PDF
                        </button>
                    </div>
                </div>

                {/* Phone Images */}
                <div className=" flex gap-4 w-[30%] max-lg:w-[70%] m z-10">
            ...
            <div className="px-4 relative py-12 max-lg:py-6 mb-20 max-lg:mb-0 max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between ">
                ...
                <div className="w-[45%] max-lg:w-[100%]">
                    ...
                    <p className="text-gray-600 mb-10">Driven by Purpose—Powered by People</p>

                    {/* Mission */}
                    <div className="mb-10 pl-5">
                        <p className="text-xl font-semibold flex items-center gap-2">
                            🚀 <span className='text-[#555D55] text-xl font-bold'>Our Mission :</span>
                        </p>
                        <p className="text-gray-700">
                            To revolutionize transportation by putting fairness, transparency,
                            and driver empowerment at the heart of everything we do.
                        </p>
                    </div>
                    ...
                    <div className="mb-10 pl-5">
                        <p className="text-xl font-semibold flex items-center gap-2">
                            🔄 <span className='text-[#555D55] text-xl font-bold'>More Than Just Rides:</span>
                        </p>
                        <p className="text-gray-700">
                            We offer ride-hailing, car recovery services, and will expand into
                            mobility support and lifestyle logistics — all under one unified platform.
                        </p>
                    </div>
                    ...
                    <div className='mb-10 pl-5'>
                        <p className="text-xl font-semibold flex items-center gap-2 ">
                            🤝 <span className='text-[#555D55] text-xl font-bold'>A Community-First Approach:</span>
                        </p>
                        <p className="text-gray-700">
                            Built under the I AM AAO empire, AAO Go is committed to creating a
                            profitable, people-centered ecosystem where every rider, driver, and user
                    ...
                    <div className="mb-10 pl-5 max-lg:mb-0">
                        <p className="text-xl font-semibold flex items-center gap-2">
                            🧭  <span className='text-[#555D55] text-xl font-bold'>Our Movement :</span>
                        </p>
                        <p className="text-gray-700">
            ...
            <div className="max-w-7xl mx-auto px-4 relative mb-32 max-lg:mb-0 py-12 flex flex-col-reverse md:flex-row items-center gap-10">
                ...
                {/* Right: Text Content */}
                <div className="w-[50%] max-lg:w-[100%] ">
                    <h2 className="text-5xl font-bold max-lg:text-4xl text-[#0B996F]  mb-4">
                        The Future We See
                    </h2>
            ...
            <div
                ref={ref}
                className="bg-[#e8f9f1] text-center py-16 px-4 mb-12 max-lg:py-8 "
            >
                ...
                <div className="flex flex-col md:flex-row justify-center items-center gap-36 max-lg:gap-10">
                    {/* Countries */}
                    <div>
                        <p className="text-5xl font-bold text-[#555D55]">
                            {inView && <CountUp end={5} duration={2} />}
                        </p>
                        <p className="text-xl text-[#555D55] mt-2">countries</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p className="text-xl text-[#555D55] mt-2">cities</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p className="text-xl text-[#555D55] mt-2">Registered Members</p>
                    </div>
                </div>
            </div>
            <div className="bg-white px-4 mb-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
                    {services.map((service, index) => (
                        <div
                            key={index}
                            className="bg-[#e8f9f1] rounded-lg p-6 flex flex-col items-center text-center shadow-black hover:shadow-2xl transition-shadow duration-300"
                        >
                            <img src={service.Image} alt="" className="w-32" />
                            <h3 className="text-2xl font-bold text-[#0A4624] mb-2">{service.title}</h3>
            ...
            <div className="bg-white py-16 px-4">
                <div className="flex justify-between items-end w-[100%] pb-10 gap-5 max-lg:flex-col">
                    <p className="w-[55%] max-lg:w-[100%] text-5xl font-bold max-lg:text-4xl text-[#0B996F]  ">Beyond Rides — The Ultimates Experience awaits</p>
                    <p className="w-[42%] max-lg:w-[100%] text-lg ">Get ready for the ultimate taxi experience — reliable rides, friendly drivers, and seamless journeys, all at your fingertips</p>
                </div>
                <div className="max-w-7xl mx-auto">
                    ...
                    {groups.map((group, idx) => (
                        <div
                            key={idx}
                            className={`grid gap-6 ${group.length === 3
                        ...
                        >
                            {group.map((option, i) => (
                                <div
                                    key={i}
                                    className="rounded-3xl p-6 py-10 bg-white text-green-900 border border-gray-200 shadow-md transition-all duration-300 hover:bg-[#0B996F] hover:text-white hover:shadow-lg group cursor-pointer"
                                >
                                    <div className="w-16 h-16 rounded-full flex items-center justify-center mb-4 bg-[#e8f9f1] text-[#0B996F] group-hover:bg-white group-hover:text-[#0ea36e] transition-all duration-300 text-2xl">
                                        {option.icon}
                                    </div>
                    ...
                    <div>
                        ...
                        <div className="flex gap-12 mb-10">
                            ...
                            <div>
                                ...
                                <p className="text-gray-600 text-sm">years of combined experience</p>
                            </div>
                        </div>

                        {/* Optional Path Graphic */}
                        <img src={locationPath} alt="Path" className="h-48" />
                    </div>

                    {/* Right Side - Testimonial Slider + Images */}
                    <div className="grid grid-cols-2 gap-4">
                        {/* Testimonial Slider */}
                        <div className="col-span-2 bg-green-100 p-6 rounded-2xl shadow-md">
                            <Slider {...sliderSettings}>
                                {testimonials.map((t, index) => (
                                    <div key={index} className="px-2">
                                        <div className="text-center">
                                            <div className="text-green-600 text-lg mb-2">★★★★★</div>
                                            <p className="text-gray-700 mb-4 text-sm">{t.review}</p>
