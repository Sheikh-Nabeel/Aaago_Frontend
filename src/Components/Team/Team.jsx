...
const Team = () => {
  ...
  const teamMembers = [
    ...
    },
    {
      ...
      description:
        'Meet our CTO officer, his name is Sardar Muhammad Abdul Samad Khan. He has a Master’s degree in Software Engineering. He has 10 years of experience in mobile application and website development. He has his own software house in which 100 employees work and he is the CEO of this company. He has received the Best Developer Award from the Government of Pakistan in 2018.',
    },
  ];
    ...
    <>
      ...
      <div className="px-6 py-10 md:px-10 flex flex-col md:flex-row items-start gap-10">
        ...
        <div className="flex flex-col w-full md:w-[55%]">
          ...
          <p className="text-gray-700 text-[.9rem] leading-relaxed mb-6">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between px-8 py-12">
        <div className="md:w-1/2 space-y-4">
          ...
          <div className="bg-black text-white px-4 py-2 inline-block font-semibold tracking-wider">
            MR MI KHAN BUDDA KHEL
          </div>
          <h4 className="font-bold text-lg mt-2">(CEO)</h4>
          ...
          <button className="bg-[#319A64] text-white px-6 py-2 rounded hover:bg-green-700 mt-5">
            <a
      ...
      <div className="px-4 py-12 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {teamMembers.map((member, index) => (
            <div
              key={index}
              className="bg-gray-100 rounded-lg overflow-hidden p-4 flex flex-col items-center"
            ...
            >
              ...
              <button
                ...
                className="mt-4 bg-[#319A64] text-white px-4 py-2 rounded hover:bg-green-700 transition flex items-center gap-1"
              >
