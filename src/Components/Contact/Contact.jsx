...
const Contact = () => {
    ...
    return (
        <>
            ...
            <div className=" w-[95%] mx-auto text-green-800 px-6 py-10 md:flex md:justify-between md:items-start gap-10">
                {/* Left Section */}
                <div className="md:w-1/2 space-y-6">
                    <h2 className="text-3xl font-bold">Get In Touch With Us</h2>
                    <p className="text-gray-600">Get in Touch – Your Ride is Just a Call Away!</p>
                    ...
                    <div className="flex gap-8 max-lg:flex-col">
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p>Office Address: Alabraj Street<br />Business Bay Dubai UAE,</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p>+1 (917) 426-0742<br />support@aaaogo.com</p>
                            </div>
                        </div>
                    </div>
                    <hr />
                ...
                {/* Right Section */}
                <div className="md:w-1/2 mt-10 md:mt-0 bg-green-100 p-6 rounded-2xl">
                    <h3 className="text-2xl font-bold mb-4">Leave Us A Message</h3>
                    <form className="space-y-4">
                        <div>
                            <label className="block mb-1 ">Name</label>
                            <input type="text" placeholder="Name" className="w-full p-2 rounded border border-green-300 bg-white focus:outline-none focus:ring-2 focus:ring-green-400" />
                        </div>
                        <div>
                            <label className="block mb-1 ">Email</label>
                            <input type="email" placeholder="Email" className="w-full p-2 rounded border border-green-300 bg-white focus:outline-none focus:ring-2 focus:ring-green-400" />
                        </div>
                        <div>
                            <label className="block mb-1 ">Message</label>
                            <textarea rows="5" placeholder="Message" className="w-full p-2 rounded border border-green-300 bg-white focus:outline-none focus:ring-2 focus:ring-green-400"></textarea>
                        </div>
